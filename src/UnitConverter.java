...
public class UnitConverter {
    ...
    private void initializeUnits(){     // the smaller the convertion factor the bigger the unit
        metricUnits.put("mm", 1000.0);
        metricUnits.put("cm", 100.0);
        metricUnits.put("m", 1.0);
        metricUnits.put("km", 0.001);

        imperialUnits.put("in", 12.0);
        imperialUnits.put("ft",1.0);
        imperialUnits.put("mi",1.0/5280.0);
    }
